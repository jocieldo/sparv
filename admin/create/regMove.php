...
?>
    <div id="local">
        ...
        <div class="caminho">
            Painel Administrativo &gt; <a href='painel.php?spv=nav/regoptions'>Regras Extras</a> &gt; <a href='painel.php?spv=nav/regMove'>Regra de Movimentação</a> &gt; Criar
        </div><!-- fecha caminho -->
    ...
    <div class="pagmodelos">
        ...
        <?php 
            ...
            if(isset($_POST['criaRegraTime'])){
                ...
                if (!empty($_POST['perguntaId']) and !empty($_POST['modelo']) and !empty($_POST['criterio'])) {
                   ...
                   $modelo   = $_POST['modelo'];
                    ...
                    $pontuacao = $_POST['pontos'];
                        ...
                        $sqlReg = "INSERT INTO sv_regrasmovimento (IdPergunta, idModelo, posicao, pontuacao, tempoInicial, tempoFinal) ".
                                                           "VALUES(:IdPergunta, :idModelo, :posicao, :pontuacao, :tempoInicial, :tempoFinal)";
