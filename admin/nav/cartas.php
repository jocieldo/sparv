...
<div id="content">
    ...
    <div class="pagcartas">
        ...
        $sql = "SELECT COUNT(*) AS total FROM `sv_cartas`";
        // Executa a consulta
        ...
        $sql = "SELECT * FROM `sv_cartas` ORDER BY `cartaNumero` DESC LIMIT ".$inicio.", ".$_BS['PorPagina'];
        // Executa a consulta
        $query = mysql_query($sql);
        ...
        // Começa a exibição dos paginadores
            ...
            echo "<a class='pag' href='painel.php?spv=nav/cartas&pagina=1'> Primeira </a>";
            for ($i = $comeco; $i <= $fim; $i++){
             ...
             else
             {
              ...
              {
                if ($i<10) { $i = "0".$i; }
               echo '<a href="painel.php?spv=nav/cartas&pagina='.$i.'">'.$i.'</a>&nbsp;&nbsp;';
              }
             }
            }

            echo '<a href="painel.php?spv=nav/cartas&pagina='.$paginas.'"> Ultima </a>&nbsp;&nbsp;';
