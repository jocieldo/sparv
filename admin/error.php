        ...
        <div id="content">            
            ...
            <div id="corpo">
                <form name="form_log" id="form_log" method="POST" action="<?php echo $loginFormAction; ?>">
                    <div id="form_content">
                    Login (*e-mail):<br/>
                    <input class="tf" name="email" type="text" title="Digite aqui seu e-mail."/><br/>
                    Senha:<br/>
                    <input class="tf" name="senha" type="password" title="Digite aqui sua senha."/><br/>
                    <input name="btn_entrar" id="btn_entrar" type="submit" value="Entrar" title="Após fornecer o código de acesso. Clique aqui para acessar o game."/>                    
                    <div class="error">Email ou senha não conferem.</div>
                    </div>
                </form>                
            </div>
            <div id="footer">
