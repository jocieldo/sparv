...
<div id="content">
    ...
    <div class="pagcartas">
        ...
        $sql = "SELECT COUNT(*) AS total FROM `sv_cartas` WHERE ( (cartaCor LIKE '%".$busca."%') OR (cartaDesc = '".$busca."') OR(cartaSimbolo LIKE '".$busca."'))";
        // Executa a consulta
        ...
        $sql = "SELECT * FROM `sv_cartas` WHERE ( (cartaCor LIKE '%".$busca."%') OR (cartaDesc = '".$busca."') OR(cartaSimbolo LIKE '".$busca."')) ORDER BY `cartaNumero` DESC LIMIT ".$inicio.", ".$_BS['PorPagina'];
        // Executa a consulta
        $query = mysql_query($sql);
