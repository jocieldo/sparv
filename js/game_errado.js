				...
				$.each(retorno.Instrucoes,function(key,val){
					...
					if((key+1) == retorno.Instrucoes.length)
					{
						$("#instrucoes").append("<div id='instrucao"+(key+1)+"' style='width:800px;display:none;'>" + 
												...
												"<div class='corpoInst'>" +
													"<div class='boxInst'>" +
														"<input style='width:80px;' class='botao instrucaoBotao' onClick='javascript:hideShowIntructions(\"instrucao"+(key+1)+"\",\"START\");' type='button' id='inst"+(key+1)+"' value='Iniciar Jogo'/>" +
														"<div style='font-weight:bold;font-size:35px;float:right;margin-top:50px;margin-right:-30px;'>"+(key+1)+" de "+tamanhoInstrucoes+"</div>" +
														"<input style='width:80px;margin-right:20px;' class='botao instrucaoBotao' onClick='javascript:hideShowIntructions(\"instrucao"+(key+1)+"\",\"instrucao"+(key)+"\");' type='button' id='inst"+(key+1)+"' value='Voltar'/>" +
													"</div>" +
												"</div>" +
					...
					if(primeiro == 0)
					{
						$("#instrucoes").append("<div id='instrucao"+(key+1)+"' style='width:800px;'>" + 
												...
												"<div class='corpoInst'>" +
													"<div class='boxInst'>" +
														"<input style='width:80px;' class='botao instrucaoBotao' onClick='javascript:hideShowIntructions(\"instrucao"+(key+1)+"\",\"instrucao"+(key+2)+"\");' type='button' id='inst"+(key+1)+"' value='Próxima'/>" +
														"<div style='font-weight:bold;font-size:35px;float:right;margin-top:50px;margin-right:-30px;'>"+(key+1)+" de "+tamanhoInstrucoes+"</div>" +
														"<input style='width:80px;margin-right:20px;' class='botao instrucaoBotao' onClick='javascript:hideShowIntructions(\"instrucao"+(key+1)+"\",\"instrucao"+(key)+"\");' type='button' id='inst"+(key+1)+"' disabled=disabled value='Voltar'/>" +
													"</div>" +
												"</div>" +
												"<p class='instrucao'>"+val+"</p></div>");
						primeiro++;
